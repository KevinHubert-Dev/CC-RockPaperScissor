 ...
 */
const combinations = [
  [choices.ROCK, choices.ROCK, results.DRAW, "Both chose rock"],
  [choices.PAPER, choices.PAPER, results.DRAW, "Both chose paper"],
  [choices.SCISSOR, choices.SCISSOR, results.DRAW, "Both chose scissor"],
